...
@Component({
  selector: 'app-create-digitalreq-lead',
  templateUrl: './create-digitalreq-lead.component.html',
  styleUrls: ['./create-digitalreq-lead.component.css']
})
export class CreateDigitalreqLeadComponent implements OnInit {
  ...
  id = this.data;
  constructor(
    public dialogRef: MatDialogRef<CreateDigitalreqLeadComponent>,
  ...
  submit() {
    if (this.addForm.invalid == true) {
      ...
      //console.log(data);
      data.id = this.id;
      this.adminservice.saveAssignDigitalLead(data).then(
        data => {
