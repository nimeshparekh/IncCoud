...
@Component({
  selector: 'app-create-mailreq-lead',
  templateUrl: './create-mailreq-lead.component.html',
  styleUrls: ['./create-mailreq-lead.component.css']
})
export class CreateMailreqLeadComponent implements OnInit {
  ...
  id = this.data;
  constructor(
    public dialogRef: MatDialogRef<CreateMailreqLeadComponent>,
  ...
  submit() {
    if (this.addForm.invalid == true) {
      ...
      //console.log(data);
      data.id = this.id;
      this.adminservice.saveAssignLeadmail(data).then(
        data => {
