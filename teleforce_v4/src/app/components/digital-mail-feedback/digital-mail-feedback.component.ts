...
@Component({
  selector: 'app-digital-mail-feedback',
  templateUrl: './digital-mail-feedback.component.html',
  styleUrls: ['./digital-mail-feedback.component.css']
})
export class DigitalMailFeedbackComponent implements OnInit {
  ...
  constructor( 
    ...
    public dialogRef: MatDialogRef<DigitalMailFeedbackComponent>,
