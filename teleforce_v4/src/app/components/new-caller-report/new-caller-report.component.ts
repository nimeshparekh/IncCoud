...
@Component({
  selector: 'app-new-caller-report',
  templateUrl: './new-caller-report.component.html',
  styleUrls: ['./new-caller-report.component.css']
})
export class NewCallerReportComponent implements OnInit {
  ...
  async searchData(){
    ...
    this.reportservice.new_caller_report(data).then(
      data => {
