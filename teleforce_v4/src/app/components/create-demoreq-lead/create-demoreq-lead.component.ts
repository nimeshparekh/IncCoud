...
@Component({
  selector: 'app-create-demoreq-lead',
  templateUrl: './create-demoreq-lead.component.html',
  styleUrls: ['./create-demoreq-lead.component.css']
})
export class CreateDemoreqLeadComponent implements OnInit {
  ...
  id = this.data;
  constructor(
    public dialogRef: MatDialogRef<CreateDemoreqLeadComponent>,
  ...
  submit(){
    if (this.addForm.invalid == true) {
      ...
      //console.log(data);
      data.id = this.id;
        this.adminservice.saveAssignLead(data).then(
          data => {
