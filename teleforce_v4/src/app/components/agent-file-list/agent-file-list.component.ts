...
@Component({
  selector: 'app-agent-file-list',
  templateUrl: './agent-file-list.component.html',
  styleUrls: ['./agent-file-list.component.css']
})
export class AgentFileListComponent implements OnInit {
  ...
  constructor(private http: HttpClient, public dialogRef: MatDialogRef<AgentFileListComponent>) { }
